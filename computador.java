public class Computador {
    ...
    public static void main(String[] args) {
        ...
        Computador laptop = new Computador("laptop", "Dell", "Latitud", "Gris espacial", "11 pulgadas", "Windows 11", 6, 128, "Intel i5", 256, "Nuevo", 2);
        Computador laptop = new Computador("laptop", "Lenovo", "ThinkSystem", "Negro", "Rack 1U", "Linux", 64, 2048, "AMD EPYC", 4000, "Nuevo", 8);
        Computador laptop = new Computador("laptop", "Asus", "ROG", "Rojo", "N/A", "Windows 11", 32, 1024, "Intel i9", 2000, "Nuevo", 6);
    }
}
